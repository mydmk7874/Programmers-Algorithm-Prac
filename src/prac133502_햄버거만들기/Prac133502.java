...
// 상수의 앞에 아래서부터 위로 쌓이게 되고, 상수는 순서에 맞게 쌓여서 완성된 햄버거를 따로 옮겨 포장을 하게 됩니다.
...
//        if(list.get(i).equals(1) && list.get(i+1).equals(2) &&
//        list.get(i+2).equals(3) && list.get(i+3).equals(1) ) {
//        answer++;
//        list.remove(i);
//        list.remove(i);
//        list.remove(i);
...
//        }
//        }
//        if(list.size() < 4 || check == answer) break;
//
//        }
//
//        return answer;